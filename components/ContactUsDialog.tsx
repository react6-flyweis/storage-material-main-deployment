...
export default function ContactUsDialog({
  ...
  async function onSubmit(data: ContactFormValues) {
    try {
      ...
      if (formattedPhone) {
        let rawPhone = formattedPhone.replace(/[^0-9]/g, "");
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent 
        ...
        className="max-w-[95vw] lg:max-w-[1000px] p-0 rounded-2xl border-white border-2 overflow-hidden shadow-2xl max-h-[95vh] flex flex-col"
      >
